...
```{r include_image5, echo=FALSE, out.width='80%', fig.align='center', fig.cap="Map of probabilities"}
knitr::include_graphics("../output/map_wealth.png")
```

```{r include_image2, echo=FALSE, out.width='80%', fig.align='center', fig.cap="Map of probabilities"}
knitr::include_graphics("../output/map_educ.png")
```

```{r include_image3, echo=FALSE, out.width='80%', fig.align='center', fig.cap="Map of probabilities"}
knitr::include_graphics("../output/map_age.png")
```


```{r include_image4, echo=FALSE, out.width='80%', fig.align='center', fig.cap="Map of probabilities"}
